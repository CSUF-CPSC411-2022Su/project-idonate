//
//  First Lutheran Church - Food Distribution Center .swift
//  iDonate
//
...
struct location9View: View {
    @StateObject var location9Inst = inventory1()
